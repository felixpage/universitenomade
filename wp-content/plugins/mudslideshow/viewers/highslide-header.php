<?php
	...
	wp_register_script('hs-full', muds_plugin_url('/3rdparty/highslide/highslide-full.js'), array('jquery', 'hs-config'), MUDS_HEADER_V);
	...
	if(file_exists($css)) {
		...
		$css_register = muds_plugin_url("/3rdparty/highslide/highslide.css");
	}
	//Declare style
...
hsConfig('<?php echo muds_plugin_url('/3rdparty/highslide/graphics/'); ?>');
