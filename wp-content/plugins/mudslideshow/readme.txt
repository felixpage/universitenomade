...
In order to use any of those viewers, this plugin would require you to install another plugin or to upload the specific library inside the __3rdparty__ directory. See FAQ for mor details. 
...
3. Upload the library or install the 3rd party plugin you would use as the viewer. 
Inside __Options/Mudslideshow__ you can see where are and how to install these
3rd party __plugins/libraries__.
4. Activate the Widget if you want a random photo in the sidebar.
5. You can use mudslide.css, lytebox.css and highslide.css to create your own style (see FAQ).
6. You can use hs-config.js to set a special behavior to highslide (see FAQ).

== Frequently Asked Questions ==

= I can't select any viewer, but none =

Sin release 0.12.10, MudSlideShow requieres you to: a) install a 3rd party plugin
if you would use a library with a GPL license (FancyBox and PrettyPhoto), ot b)
upload the javascript library to the 3rdparty directory if this library doesn't use a
GPL compatible license (LyteBox, HighSlide).

To use FancyBox you would require to install and activate __[easy-fancyBox](http://wordpress.org/extend/plugins/easy-fancybox/ "Plugin by RavanH")__,
or in case you use PrettyPhoto, you wuold have to use __[PrettyPhoto Media](http://wordpress.org/extend/plugins/prettyphoto-media/ "Plugin by Pier-Luc")__.

To use HighSlide, download it from __[here](http://highslide.com/download.php)__, unpack, and FTP the 'highslide' directory to 'mudslideshow/3rdparty'. 
To use Lytebox, download it from __[here](http://lytebox.com/)__, unpack, rename the 'lytebox_Vx.x' as 'lytebox' and FTP it to 'mudslideshow/3rdparty'.
...
* First release with galician translation. Thanks __Pablo César Galdo__.
